...
const Index = () => {
  ...
  return (<Layout >
    ...
    <div className="aboutme">
      ...
      <h3 style={{backgroundColor: '#EEFBFB'}}>Skills</h3>
      <div style={{width: '100%', display: 'flex', justifyContent: 'center', margin: 'auto', flexWrap: 'wrap', backgroundColor: '#EEFBFB', paddingBottom: 70}}>
        ...
        <img style={imgStyle} src="https://www.brandeps.com/logo-download/N/Node-JS-logo-vector-01.svg"/>
        ...
        <img style={imgStyle} src="https://www.brandeps.com/logo-download/M/Materialize-CSS-logo-vector-01.svg"/>
