...
const Index = () => {
  ...
  return (<Layout >
    ...
    <div className="aboutme">
      ...
      I am a software engineer with a background in customer facing engineering roles.  I have experience with high-traffic, industry critical web pages that required extensive compliance-oriented design, and unique customer requirements.  I have quickly adapted to software development and have applied past professional experience to develop applications which will allow clients to perform daily tasks at optimum efficiencies.
      <br/><br/>  
